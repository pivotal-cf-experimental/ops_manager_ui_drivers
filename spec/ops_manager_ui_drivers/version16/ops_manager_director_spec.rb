  ...
  module Version16
    describe OpsManagerDirector do
      ...
      let(:iaas_configuration) do
        Version16::MicroboshSections::IaasConfiguration.new(browser: browser).tap do |iaas_configuration|
          allow(iaas_configuration).to receive(:set_field)
        end
      end
      let(:advanced_infrastructure_configuration) { Version16::MicroboshSections::AdvancedInfrastructureConfig.new(browser: browser) }
