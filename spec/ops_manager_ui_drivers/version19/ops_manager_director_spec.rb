  ...
  module Version19
    describe OpsManagerDirector do
      ...
      let(:iaas_configuration) do
        Version19::BoshProductSections::IaasConfiguration.new(browser: browser).tap do |iaas_configuration|
          allow(iaas_configuration).to receive(:set_field)
        end
      end
      let(:advanced_infrastructure_configuration) { Version19::BoshProductSections::AdvancedInfrastructureConfig.new(browser: browser) }

      let(:test_settings_hash) { {} }

      subject(:ops_manager_director) do
        OpsManagerUiDrivers::Version19::OpsManagerDirector.new(browser: browser, iaas_configuration: iaas_configuration)
      end
      ...
      before do
        ...
        allow(Version19::BoshProductSections::AdvancedInfrastructureConfig).to receive(:new).and_return(advanced_infrastructure_configuration)
